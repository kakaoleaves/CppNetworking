...
int main()
{
	...
	// Bind socket to the local socket address
	...
	while (true) // Run forever
	{
		...
		int recvLen = ::recvfrom(serverSocket, recvBuffer, sizeof(recvBuffer), 0, (SOCKADDR*)&clientAddr, &clientAddrSize);
		...
		// send back
		int resultCode = ::sendto(serverSocket, response_c, (int)strlen(response_c), 0, (SOCKADDR*)&clientAddr, sizeof(clientAddr));
